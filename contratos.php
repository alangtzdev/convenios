...
<div class="ui container" id="idDivBody">
    ...
    <div class="main ui container">
        ...
        <div class="ui hidden divider"></div>
        <div class="ui hidden divider"></div>
        <table id="tableContratos" class="ui celled table" style="width:100%">
            <thead>
                <tr>
                    <th class="">Nombre</th>
                    <th>Contraparte</th>
                    ...
                    <div class="field">
                        <div class="fields">
                            <div class="six wide field">
                                ...
                                <input type="text" id="txtNombre" name="name" placeholder="Nombre / instrumento juridico">
                            </div>
                        ...
                        <div class="fields">
                            <div class="eleven wide field divInputUpload" id="divArchivoNuevo">
                                ...
                                <div class="ui labeled input">
                                    ...
                                    <input type="file" id="idArchivo" name="archivoNuevo" data-hfencryp="HFEncrypArchivo" data-hfruta="HFRutaArchivo" data-idprogress="#archivoResult" data-idlblresult="glosaArchivos" style="display: none">
                        ...
                        <div class="fields">
                            <div class="eight wide field divInputUpload" id="divArchivoFinanParcial">
                                ...
                                <div class="ui labeled input">
                                    ...
                                    <input type="file" id="idArchivoFinaParcial" name="archivoNuevo" data-hfencryp="HFEncrypFinanParcial" data-hfruta="HFRutaFinanParcial" data-idprogress="#progressArchivoFinaParcial" data-idlblresult="lblFinParcial" style="display: none">
                            ...
                            <div class="eleven wide field divLabel" id="divArchiConsulFinanParcial">
                                <label for="">Informe financiero parcial</label>
                                <a target="_blank" id="aRefFinaParcial" href="" type="button" class="ui teal icon button"><i class="fa fa-file"></i></a>
                            ...
                            <div class="eight wide field divInputUpload">
                                ...
                                <div class="ui labeled input">
                                    ...
                                    <input type="file" id="idArchivoFinFinal" name="archivoNuevo" data-hfencryp="HFEcrypFinanFinal" data-hfruta="HFRutaFinanFinal" data-idprogress="#progreArchivoFinFinal" data-idlblresult="lblFinFinal" style="display: none">
                            ...
                            <div class="eleven wide field divLabel" id="divArchiConsulFinanParcial">
                                <label for="">Informe financiero final</label>
                                <a target="_blank" id="aRefFinFinal" href="" type="button" class="ui teal icon button"><i class="fa fa-file"></i></a>
                        ...
                        <div class="fields">
                            <div class="eight wide field divInputUpload">
                                ...
                                <div class="ui labeled input">
                                    ...
                                    <input type="file" id="idArchivoTecParcial" name="archivoNuevo" data-hfencryp="HFEncrypTecnicoParcial" data-hfruta="HFRutaTecnicoParcial" data-idprogress="#progreArchivoTecParcial" data-idlblresult="lblTecParcial" style="display: none">
                            ...
                            <div class="eleven wide field divLabel" id="divArchiConsulFinanParcial">
                                <label for="">Informe tecnico parcial</label>
                                <a target="_blank" id="aRefTecParcial" href="" type="button" class="ui teal icon button"><i class="fa fa-file"></i></a>
                            ...
                            <div class="eight wide field divInputUpload">
                                ...
                                <div class="ui labeled input">
                                    ...
                                    <input type="file" id="idArchivoTecFinal" name="archivoNuevo" data-hfencryp="HFEncrypTecnicoFinal" data-hfruta="HFRutaTecnicoFinal" data-idprogress="#progreArchivoTecFinal" data-idlblresult="lblTecFinal" style="display: none">
                            ...
                            <div class="eleven wide field divLabel" id="divArchiConsulFinanParcial">
                                <label for="">Informe tecnico final</label>
                                <a target="_blank" id="aRefTecFinal" href="" type="button" class="ui teal icon button"><i class="fa fa-file"></i></a>
