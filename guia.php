    ...
    <div class="ui container">
        ...
        <div class="exmaple">
            ...
            <div class="ui tiny breadcrumb">
                ...
                <i class="right chevron icon divider"></i>
                <div class="active section"><i class="fa fa-plus"> </i> Nuevo Usuario</div>
            </div>
            ...
            <div class="ui tiny breadcrumb">
                ...
                <i class="right chevron icon divider"></i>
                <div class="active section"><i class="fa fa-plus"> </i> Nueva Institucion</div>
            </div>
            ...
            <div class="ui tiny breadcrumb">
                ...
                <i class="right chevron icon divider"></i>
                <div class="active section"><i class="fa fa-plus"> </i> Nuevo Catalogo</div>
            </div>
