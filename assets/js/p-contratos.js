        ...
        success: function(response) {
            ...
            $('#tableContratos').DataTable({
                ...
                columns: [{
                    ...
                    {
                        mRender: function(data, type, full) {
                            return '<button id="btnEliminar" data-toggle="tooltip" data-placement="left" title="Eliminar" type="button" class="ui red icon button btnEliminar" onclick="deleteContrato(' + full.idContrato + ')" disabled/><i class="fa fa-trash"></i></button>';
                        },
                        width: "8%",
                    }
                ]
