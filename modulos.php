...
<div class="ui container" id="idDivBody">
    ...
    <div class="main ui  container">
        ...
        <table id="tableModulos" class="ui celled table" style="width:100%">
            <thead>
                <tr>
                    <th>Modulo</th>
                    <th>Indice</th>
                    ...
                    <div class="field">
                        <div class="fields">
                            <div class="four wide field">
                                ...
                                <input type="text" id="txtNombre" name="name" placeholder="Nombre modulo">
                            </div>
                            <div class="four wide field">
                                <label>Indice</label>
                                <input type="text" id="txtIndice" name="indice" placeholder="Ejemplo: modulo +.php">
                            </div>
                            <div class="four wide field">
                                <label>Ruta</label>
                                <input type="text" id="txtApellido" name="ruta" placeholder="ruta del modulo">
                            </div>
                            <div class="four wide field">
                                <label>Icono</label>
                                <input type="text" id="txtIcono" name="ruta" placeholder="Ejemplo: fa-fa-plus">
                            </div>
                        </div>
                    </div>
